...
p5 <- ols_plot_reside_stud_fit(bp_reduced)
...
```{r}
#With interactions
bp_full_int <- lm(data=bp_train, sbp ~ gender + married + smoke + exercise + age + weight + height + race + alcohol + trt + bmi + stress + salt + chldbear + income + educatn + overwt + income:educatn + gender:chldbear + stress:alcohol + stress:chldbear + stress:weight + stress:overwt + income:age + weight:overwt + bmi:weight + bmi:height  + alcohol:smoke  + income:stress + educatn:stress  + smoke:exercise + income:chldbear  + alcohol:income + chldbear:married + salt:exercise)
